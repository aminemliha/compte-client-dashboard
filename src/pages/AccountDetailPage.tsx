...
const AccountDetailPage = () => {
  ...
  const accountDetailsData = [{
    label: "Numéro Original",
    value: account.numeroOriginal
  }, {
    label: "Numéro Client Host",
    value: account.numeroClientHost
  }, {
    label: "Numéro avec Lettres",
    value: account.numeroAvecLettres
  }, {
    label: "Code Agence",
    value: account.agenceCode
  }, {
    label: "Bilan",
    value: account.bilan
  }, {
    ...
    label: "Solde",
    value: `${account.solde.toLocaleString()} ${account.devise}`
  }, {
    label: "Adresse",
    value: account.adresse || "N/A"
  }, {
    label: "Téléphone",
    value: account.telephone || "N/A"
  }, {
    label: "Email",
    value: account.email || "N/A"
  }, {
    label: "Abonnement",
    value: account.subscription || "Standard"
  }, {
    label: "Limite de Découvert",
    value: `${account.overdraftLimit || 0} ${account.devise}`
  }, {
        ...
        <CardContent>
          <div className="rounded-md border overflow-hidden">
            <Table>
              ...
              <TableBody>
                {accountDetailsData.map((item, index) => <TableRow key={index}>
        ...
        <CardContent>
          <div className="rounded-md border overflow-hidden">
            <Table>
              ...
              <TableBody>
                {account.cards && account.cards.length > 0 ? account.cards.map((card, index) => <TableRow key={index}>
